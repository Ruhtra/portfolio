...
export default function Projects() {
  ...
  return (
    <section id="projects" className="section-container scroll-mt-16 bg-muted/30">
                  ...
                  <CardFooter className="flex justify-between">
                    <Dialog>
                      <DialogTrigger asChild>
                        <Button variant="ghost" size="sm" onClick={() => setSelectedProject(project)} className="group">
