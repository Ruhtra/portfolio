  ...
  const education = [
    {
      ...
      institution: "CE EDUC PROFIS SEN JESSE PINTO FREIRE - CENEP",
      period: "2018 – 2021",
      achievements: [
        "Desenvolvimento de TCC sobre criação de um PWA (Progressive Web App)",
        "Participação em curso de Robótica com Arduino",
        "Formação técnica integrada ao ensino médio regular",
      ],
    },
  ]
