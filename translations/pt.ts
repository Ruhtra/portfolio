...
export const pt = {
  ...
  "cv.personal.title": "Desenvolvedor Full Stack",
  "cv.personal.age": `${mainInfo.personal.age} anos`,
  "cv.personal.photo": "/picture.jpeg?height=400&width=400",
  "cv.contact.title": "Contato",
  "cv.contact.email.label": "Email",
  "cv.contact.email.value": mainInfo.personal.email,
  "cv.contact.phone.label": "Telefone",
  "cv.contact.phone.value": mainInfo.personal.phone,
  "cv.contact.address.label": "Endereço",
  ...
  "cv.skills.languages.title": "Linguagens",
  ...
  "cv.skills.databases.title": "Banco de Dados",
  ...
  "cv.skills.devops.title": "DevOps & Práticas",
  ...
  "cv.languages.portuguese": "Português",
  "cv.languages.portuguese.level": "Nativo",
  "cv.languages.english": "Inglês",
  "cv.languages.english.level": "Intermediário",
  "cv.about.title": "Sobre",
  "cv.about.content": `Sou desenvolvedor Fullstack com sólida experiência em desenvolvimento web e foco no aprendizado contínuo. Desde os 13 anos, crio projetos por curiosidade e, nos últimos ${mainInfo.career.yearsOfExperience} anos, me aprofundei profissionalmente, aprimorando minhas habilidades para escrever códigos bem estruturados, legíveis e alinhados às melhores práticas do mercado.`,
  ...
  "cv.education.technical.period": "Janeiro de 2018 - Novembro de 2020",
